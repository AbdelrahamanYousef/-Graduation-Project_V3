        ...
        <div className="flex flex-col gap-6">
            <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-4">
                    <div className="bg-white dark:bg-neutral-100 rounded-lg shadow-card border border-neutral-100 dark:border-neutral-100 relative overflow-hidden flex flex-col items-center justify-center text-center p-6 h-full">
                        ...
                        <p className="text-sm text-neutral-500">{'إجمالي تبرعاتك'}</p>
                    </div>
                </div>
                <div className="col-span-12 md:col-span-4">
                    <div className="bg-white dark:bg-neutral-100 rounded-lg shadow-card border border-neutral-100 dark:border-neutral-100 relative overflow-hidden flex flex-col items-center justify-center text-center p-6 h-full">
                        ...
                        <p className="text-sm text-neutral-500">{'عدد التبرعات'}</p>
                    </div>
                </div>
                <div className="col-span-12 md:col-span-4">
                    <div className="bg-white dark:bg-neutral-100 rounded-lg shadow-card border border-neutral-100 dark:border-neutral-100 relative overflow-hidden flex flex-col items-center justify-center text-center p-6 h-full">
                        ...
                        <p className="text-sm text-neutral-500">{'متوسط التبرع'}</p>
                    </div>
                </div>
            </div>

            <div className="bg-white dark:bg-neutral-100 rounded-lg shadow-card border border-neutral-100 dark:border-neutral-100 overflow-hidden">
                <div className="p-4">
                    <h6 className="text-base font-bold mb-3 dark:text-white">{'آخر التبرعات'}</h6>
                    <hr className="border-t border-neutral-200 mb-3" />
                    <div className="flex flex-col gap-3">
                        {donations.length === 0 ? (
                            ...
                            donations.slice(0, 3).map(donation => (
                                <div key={donation.id} className="flex justify-between items-center py-2 border-b border-neutral-200 last:border-b-0">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <span className="text-xs text-neutral-500">{formatDate(donation.date)}</span>
                                    </div>
                                </div>
                            ))
                        )}
            ...
            <div>
                ...
                <div className="grid grid-cols-12 gap-4">
                    <div className="col-span-12 md:col-span-4">
                        <Link to="/donate" className="block bg-white dark:bg-neutral-100 rounded-lg shadow-card border border-neutral-100 dark:border-neutral-100 p-8 text-center cursor-pointer hover:-translate-y-1 hover:shadow-lg transition-all h-full flex flex-col items-center justify-center">
                    ...
                    <div className="col-span-12 md:col-span-4">
                        <Link to={paths.programs} className="block bg-white dark:bg-neutral-100 rounded-lg shadow-card border border-neutral-100 dark:border-neutral-100 p-8 text-center cursor-pointer hover:-translate-y-1 hover:shadow-lg transition-all h-full flex flex-col items-center justify-center">
                            <div className="text-3xl text-secondary-500 mb-3"><i className="fa-solid fa-folder-open"></i></div>
                            <span className="font-bold dark:text-white">{'تصفح البرامج'}</span>
                        </Link>
                    </div>
                    <div className="col-span-12 md:col-span-4">
                        <Link to="/transparency" className="block bg-white dark:bg-neutral-100 rounded-lg shadow-card border border-neutral-100 dark:border-neutral-100 p-8 text-center cursor-pointer hover:-translate-y-1 hover:shadow-lg transition-all h-full flex flex-col items-center justify-center">
