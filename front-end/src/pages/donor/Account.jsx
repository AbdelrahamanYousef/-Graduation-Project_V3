...
function Account() {
    ...
    return (
        <div className="py-12 bg-neutral-50 dark:bg-neutral-50 min-h-[90vh]">
            <div className="max-w-[1200px] mx-auto px-4 md:px-6">
                {/* Header */}
                <div className="flex items-center justify-between flex-wrap gap-6 mb-8 p-6 bg-white dark:bg-neutral-100 rounded-lg shadow-card">
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            ...
                            <button
                                className="absolute bottom-0 left-[-10px] p-1.5 rounded-md bg-white dark:bg-neutral-200 shadow hover:bg-neutral-50 dark:hover:bg-neutral-300 text-neutral-600 dark:text-neutral-900 transition-colors"
                                onClick={() => photoInputRef.current?.click()}
                            >
                        ...
                        <div>
                            ...
                            <p className="text-sm text-neutral-500">{'عضو منذ'} {formatDate(user.joinDate)}</p>
                        </div>
                    </div>
                ...
                {/* Tabs */}
                <div className="border-b border-neutral-200 dark:border-neutral-200 mb-6">
                ...
                <div>
                    {loading ? (
                        ...
                        <>
                            ...
                            {activeTab === 'profile' && <ProfileTab donorInfo={donorInfo} updateDonorPhoto={updateDonorPhoto} />}
                        </>
                    )}
                </div>
            </div>
